						...
						<div class="row">
							<div class="col-md-12 col-sm-12 col-xs-12">
								<div class="x_panel">
									<div class="x_title">
										<h2>
											Quản lý Loại sản phẩm <small><a href="#"
												style="color: red;">Xóa Nhiều</a></small>
											<br><br>
											<a href="khac/themloaisanpham.htm"><button
									...
									<div class="x_content">
										<table id="datatable-checkbox"
											...
											<tbody>
												<c:forEach var="u" items="${themsanphams }">
													<tr>
															...
															<div class="modal-content">
																...
																<div class="modal-footer ">
																	<a class="btn btn-danger" style="float: left;"
																		href="khac/editloaisanpham/${u.id }.htm">Sửa thông tin </a>
													...
													<div class="modal fade" id="delete${u.id }" tabindex="-1"
														...
														<div class="modal-dialog">
															<div class="modal-content">
																...
																<div class="modal-footer ">
																	<a class="btn btn-danger" style="float: left;"
																		href="khac/deleteloaisp/${u.id }.htm">Xóa </a>
																	<button type="button" class="btn btn-default"
																		data-dismiss="modal">
