					...
					<div class="">
						...
						<div class="row">
							<div class="col-md-12 col-sm-12 col-xs-12">
								<div class="x_panel">
									<div class="x_title">
										<h2>Quản lý tin khuyến mãi <small></small>
										<hr><a href="tintuc/themtintucmoi.htm"><button
									...
									<div class="x_content">	
										<table id="datatable-checkbox"
											...
											<tbody>
											<c:forEach var="u" items="${tintucmois }">
												<tr>
													<th><input type="checkbox" id="check-all" class="flat"></th>					
														<td>${u.tieude }</td>
														<td class="center"><img
															style="width: 100px; height: 100px;"
															src="files/sanpham/${u.images }" /></td>
															<td class="center"><img
															style="width: 100px; height: 100px;"
															src="files/sanpham/${u.images1 }" /></td>
															<td class="center"><img
															style="width: 100px; height: 100px;"
															src="files/sanpham/${u.images2 }" /></td>
															<td class="center"><img
															style="width: 100px; height: 100px;"
															src="files/sanpham/${u.images3 }" /></td>
															<td>${u.noidung }</td>
															<td>${u.mota }</td>
												...
												<div class="modal-content">
													...
													<div class="modal-footer ">
														<a class="btn btn-danger" style="float: left;"
															href="khac/edit/${u.id }.htm">Sửa thông tin </a>
											...
											<div class="modal-dialog">
												<div class="modal-content">
													...
													<div class="modal-footer ">
														<a class="btn btn-danger" style="float: left;"
															href="khac/deleteroles/${u.id }.htm">Xóa </a>
														<button type="button" class="btn btn-default"
															data-dismiss="modal">
