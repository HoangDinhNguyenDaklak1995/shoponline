					...
					<div class="">
						...
						<div class="row">
							<div class="col-md-12 col-sm-12 col-xs-12">
								<div class="x_panel">
									<div class="x_title">
										<h2>Quản lý sản phẩm <small><a href="#" style="color: red;">Xóa Nhiều</a></small>
										<br><br><a href="admin/themsanpham.htm"><button
													id="sample_editable_1_new" class="btn sbold green"
													type="button">
													Thêm mới <i class="fa fa-plus"></i>
												</button></a>${messagesanpham }</h2>
												<p style="color: red;">${messagesanpham }</p>
										...
										<table id="datatable-checkbox"
											...
											<c:forEach var="u" items="${sanphams }">
												<tr>
													<th><input type="checkbox" id="check-all" class="flat"></th>
														...
														<td class="center">${u.numbers }</td>				
														<td>${u.doitac.name }</td>
														<td class="comment"><p class="tin">${u.description }</p></td>
												...
												<div class="modal-content">
													...
													<div class="modal-footer ">
														<a class="btn btn-danger" style="float: left;"
															href="admin/editsanpham/${u.id }.htm">Sửa thông tin </a>
											...
											<div class="modal-dialog">
												<div class="modal-content">
													...
													<div class="modal-footer ">
														<a class="btn btn-danger" style="float: left;"
															href="admin/deletesanpham/${u.id }.htm">Xóa </a>
														<button type="button" class="btn btn-default"
															data-dismiss="modal">
